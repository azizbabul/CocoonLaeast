...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { dept: @notice.dept, general: @notice.general, name: @notice.name, semister: @notice.semister, year: @notice.year }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { dept: @notice.dept, general: @notice.general, name: @notice.name, semister: @notice.semister, year: @notice.year }
    assert_redirected_to notice_path(assigns(:notice))
  end
