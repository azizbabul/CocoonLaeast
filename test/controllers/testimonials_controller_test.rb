...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { description: @testimonial.description, name: @testimonial.name, particulars: @testimonial.particulars }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { description: @testimonial.description, name: @testimonial.name, particulars: @testimonial.particulars }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
